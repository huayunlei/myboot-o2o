...
public enum RightLevelNewEnum2 {
    ...
    RightLevelNewEnum2(int code, String name,String gradeNameUrl,String gradeBackGround,String gradeLevelIcoUrl, String gradeLevelPicUrl, String gradelLevelUrl, String gradeLevelBackPicUrl, String totalContent, String gradeClassifyDeac) {
        this.code = code;
        this.name = name;
    ...
    public static String getGradeNameUrl(int code) {
        RightLevelNewEnum2[] values = values();
        for (RightLevelNewEnum2 v : values) {
            if (v.getCode() == code) {
