...
public class JsonMapperArgumentResolver implements
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        /**
         * when parameter is defined with annotation Json;
         */
    ...
    public Object resolveArgument(MethodParameter parameter,
        ...
        try {
            ...
            allParam = allParam.replace("%", "%25");
            allParam = URLDecoder.decode(allParam, "utf-8");
            if (allParam == null || allParam.equals("")) {
                return null;
            }
            //AS the format is req=, so get the substring as the bean business datas
            allParam = allParam.substring(allParam.indexOf('=') + 1);
            try {
