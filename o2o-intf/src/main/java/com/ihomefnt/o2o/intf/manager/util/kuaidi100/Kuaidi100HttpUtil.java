...
public class Kuaidi100HttpUtil {
	...
	public synchronized static String postData(String url, Map<String, String> params, String codePage)
		...
		httpClient.getHttpConnectionManager().getParams().setConnectionTimeout(8 * 1000);
		httpClient.getHttpConnectionManager().getParams().setSoTimeout(8 * 1000);
