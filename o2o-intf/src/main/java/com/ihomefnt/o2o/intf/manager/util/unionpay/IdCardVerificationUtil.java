 ...
 */
public class IdCardVerificationUtil {

    private static final Logger logger= LoggerFactory.getLogger(IdCardVerificationUtil.class);
    /**身份证有效*/
    ...
    public static boolean validate(String idNum) {
        ...
        if (idNum.length() != 15 && idNum.length() != 18) {
            tipInfo = LACKDIGITS;
            return VALIDITY.equals(tipInfo);
        }
        ...
        if (isVarifyCode(Ai, idNum) == false) {
...
//        System.out.println(validate("321321198904252439"));
//    }
