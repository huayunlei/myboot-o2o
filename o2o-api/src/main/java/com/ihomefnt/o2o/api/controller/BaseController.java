package com.ihomefnt.o2o.api.controller;

import com.ihomefnt.o2o.common.util.ConvertUtil;
...
public class BaseController {
	 ...
	 * Date: 2018年4月12日
	 */
	protected ResponseEntity<HttpBaseResponse> commonReturn(HttpBaseResponse baseResponse) {
		MultiValueMap<String, String> headers = new HttpHeaders();
		headers.set("Access-Control-Allow-Origin", "*");
		headers.set("Access-Control-Request-Method", "post");
		return new ResponseEntity<HttpBaseResponse>(baseResponse, headers, HttpStatus.OK);
